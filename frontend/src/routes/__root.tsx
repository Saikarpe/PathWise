...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        // Inter — the conventional, highly-readable platform sans most
        // e-learning products (and most of the web) actually use, in place
        // of the previous geometric-display pairing.
        rel: "stylesheet",
